...
var nodeSchemas = require('../schemas/schema_model.js');             // 表结构 模块

var options = {
    db_user: "XLZ19930623",
    db_pwd: "ZHANGLI19930623",
    db_host: "123.206.184.149",
    db_port: 27017,
    db_name: "ApiStore"
};
...
var nodeSchema = new mongoose.Schema(nodeSchemas[table_name]);
...
//  * @param callback 回调方法
//  */
// DB.prototype.findOne = function (table_name, conditions, fields, callback) {
//     var node_model = this.getConnection(table_name);
//     node_model.findOne(conditions, fields, function (err, res) {
//         if (err) {
//             callback(err);
//         } else {
//             callback(null, res);
